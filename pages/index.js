...
export default function Home() {
  ...
  // Functions to handle smooth scrolling
  ...
  // Isomorphic effect for animations
      ...
      <div className="container mx-auto mb-10">
        ...
        <div className="laptop:mt-20 mt-10">
          <div className="mt-5">
            ...
            <h1 ref={textThree} className="text-2xl tablet:text-4xl laptop:text-4xl laptopl:text-6xl p-1 tablet:p-2 text-bold w-full laptop:w-4/5">
              {data.headerTaglineThree}
            </h1>
            <h1 ref={textFour} className="text-2xl tablet:text-4xl laptop:text-4xl laptopl:text-6xl p-1 tablet:p-2 text-bold w-full laptop:w-4/5">
